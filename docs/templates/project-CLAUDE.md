...
- Treat this file as the Claude Code / compatible tools entrypoint.
...
- Daily user-facing project commands are `开始工作`, `继续`, and `收工`; Context budget checks, candidate generation, post-resolution memory compilation, and bounded projection refresh are agent responsibilities.
