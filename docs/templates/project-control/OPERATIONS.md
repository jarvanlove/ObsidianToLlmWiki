...
- Logs, health checks, common incidents, backup/restore, monitoring, or maintenance commands change.
- A bug investigation teaches a repeatable diagnostic or prevention step.
