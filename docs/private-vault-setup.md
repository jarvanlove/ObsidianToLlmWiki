...
This public repository is the scaffold. Your personal knowledge and project knowledge should live in a private vault or private repository.

## Recommended Layout

Create a private vault with the same high-level structure:
...
1. Create a private repo or private folder for the real content.
2. Copy the public scaffold structure into it.
3. Keep the public repo as the source of conventions, prompts, and templates.
4. Put your actual personal notes and project notes only in the private vault.
...
The private vault should hold the knowledge.
