...
|---|---|---|---|
| M0 Product contract and trusted context | Task 1, 0A, 0B | L0-L3 contract is current; read-only integrity checks, bounded Context Contract, and Context Receipt pass damaged/stale/conflict/missing tests | Machine acceptance passed; product-owner approval pending |
...
- [ ] Obtain explicit product-owner approval for M0 before starting M1.
